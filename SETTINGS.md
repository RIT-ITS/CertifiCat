...
| <a href="#opt-acme-http-01-challenge-user-agent" id="opt-acme-http-01-challenge-user-agent" name="opt-acme-http-01-challenge-user-agent">acme.http_01_challenge_user_agent</a>| | `python-acmev2/0.2.1` | User agent the http-01 challenge validator uses when requesting the challenge document from the client server |
...
| <a href="#opt-certificat-alternative-finalizers" id="opt-certificat-alternative-finalizers" name="opt-certificat-alternative-finalizers">certificat.alternative_finalizers</a>| | `[]` | A list of alternative finalizers that can be selected depending on order criteria. |
...
| <a href="#opt-certificat-finalizer" id="opt-certificat-finalizer-toplevel" name="opt-certificat-finalizer-toplevel">certificat.finalizer</a> ↗|✓ | `-` | Which order finalizer module to use. The server is designed to finalize all requests against one default backend. |
...
| <a href="#opt-certificat-finalizer-acme-account-hmac-key" id="opt-certificat-finalizer-acme-account-hmac-key" name="opt-certificat-finalizer-acme-account-hmac-key">certificat.finalizer.account_hmac_key</a> | | `null` | External account binding HMAC key. |
| <a href="#opt-certificat-finalizer-acme-account-kid" id="opt-certificat-finalizer-acme-account-kid" name="opt-certificat-finalizer-acme-account-kid">certificat.finalizer.account_kid</a> | | `null` | External account binding key identifier. |
| <a href="#opt-certificat-finalizer-acme-challenges-challenge-webhook-endpoint" id="opt-certificat-finalizer-acme-challenges-challenge-webhook-endpoint" name="opt-certificat-finalizer-acme-challenges-challenge-webhook-endpoint">certificat.finalizer.challenges.challenge_webhook.endpoint</a> |✓ | `-` | URL to send the webhook request. |
| <a href="#opt-certificat-finalizer-acme-challenges-challenge-webhook-secret" id="opt-certificat-finalizer-acme-challenges-challenge-webhook-secret" name="opt-certificat-finalizer-acme-challenges-challenge-webhook-secret">certificat.finalizer.challenges.challenge_webhook.secret</a> |✓ | `-` | Shared secret used to generate webhook signatures. This should be between 24 and 64 bytes. |
| <a href="#opt-certificat-finalizer-acme-challenges-challenge-webhook-timeout" id="opt-certificat-finalizer-acme-challenges-challenge-webhook-timeout" name="opt-certificat-finalizer-acme-challenges-challenge-webhook-timeout">certificat.finalizer.challenges.challenge_webhook.timeout</a> | | `5` | Request timeout for the endpoint URL. |
| <a href="#opt-certificat-finalizer-acme-challenges-dns-01-perform-verification" id="opt-certificat-finalizer-acme-challenges-dns-01-perform-verification" name="opt-certificat-finalizer-acme-challenges-dns-01-perform-verification">certificat.finalizer.challenges.dns_01.perform_verification</a> | | `false` | Verify DNS TXT records for challenges before submitting the order. |
| <a href="#opt-certificat-finalizer-acme-challenges-dns-01-verification-nameservers" id="opt-certificat-finalizer-acme-challenges-dns-01-verification-nameservers" name="opt-certificat-finalizer-acme-challenges-dns-01-verification-nameservers">certificat.finalizer.challenges.dns_01.verification_nameservers</a> | | `["1.1.1.1"]` | A list of servers in the format ip or ip:port. The resolver will use these nameservers when verifying challenges. If left blank the system nameservers will be used. |
| <a href="#opt-certificat-finalizer-acme-challenges-dns-01-verification-timeout" id="opt-certificat-finalizer-acme-challenges-dns-01-verification-timeout" name="opt-certificat-finalizer-acme-challenges-dns-01-verification-timeout">certificat.finalizer.challenges.dns_01.verification_timeout</a> | | `60` | Timeout for challenge verification in seconds, after which the order will be marked invalid. |
...
| <a href="#opt-certificat-finalizer-certinext-agreement-signer" id="opt-certificat-finalizer-certinext-agreement-signer" name="opt-certificat-finalizer-certinext-agreement-signer">certificat.finalizer.agreement_signer</a> |✓ | `-` | Name of the agreement signer for certificate issuance |
| <a href="#opt-certificat-finalizer-certinext-agreement-signer-place" id="opt-certificat-finalizer-certinext-agreement-signer-place" name="opt-certificat-finalizer-certinext-agreement-signer-place">certificat.finalizer.agreement_signer_place</a> |✓ | `-` | Place of the agreement signer for certificate issuance |
| <a href="#opt-certificat-finalizer-certinext-api-base" id="opt-certificat-finalizer-certinext-api-base" name="opt-certificat-finalizer-certinext-api-base">certificat.finalizer.api_base</a> | | `https://us-api.certinext.io/` | Base URL of the CERTInext API. |
| <a href="#opt-certificat-finalizer-certinext-oauth-client-id" id="opt-certificat-finalizer-certinext-oauth-client-id" name="opt-certificat-finalizer-certinext-oauth-client-id">certificat.finalizer.oauth_client_id</a> | | `Client ID for the OAuth client credentials grant request` | - |
| <a href="#opt-certificat-finalizer-certinext-oauth-client-secret" id="opt-certificat-finalizer-certinext-oauth-client-secret" name="opt-certificat-finalizer-certinext-oauth-client-secret">certificat.finalizer.oauth_client_secret</a> | | `Client secret for the OAuth client credentials grant request` | - |
| <a href="#opt-certificat-finalizer-certinext-order-remarks" id="opt-certificat-finalizer-certinext-order-remarks" name="opt-certificat-finalizer-certinext-order-remarks">certificat.finalizer.order_remarks</a> | | `Submitted by CertifiCat` | Optional order remarks to include with each certificate order |
| <a href="#opt-certificat-finalizer-certinext-org-number" id="opt-certificat-finalizer-certinext-org-number" name="opt-certificat-finalizer-certinext-org-number">certificat.finalizer.org_number</a> |✓ | `-` | Organization ID that will be requesting the certificate |
...
| <a href="#opt-certificat-finalizer-certinext-product-variant" id="opt-certificat-finalizer-certinext-product-variant" name="opt-certificat-finalizer-certinext-product-variant">certificat.finalizer.product_variant</a> | | `ov` | Product variant, defaults to organization validated. |
| <a href="#opt-certificat-finalizer-certinext-requestor-designation" id="opt-certificat-finalizer-certinext-requestor-designation" name="opt-certificat-finalizer-certinext-requestor-designation">certificat.finalizer.requestor_designation</a> | | `+1` | Designation of the requestor |
...
| <a href="#opt-certificat-finalizer-certinext-requestor-phone" id="opt-certificat-finalizer-certinext-requestor-phone" name="opt-certificat-finalizer-certinext-requestor-phone">certificat.finalizer.requestor_phone</a> |✓ | `-` | Phone number of the requestor |
