...
| <a href="#opt-certificat-finalizer-acme-challenges-dns-01-verification-nameservers" id="opt-certificat-finalizer-acme-challenges-dns-01-verification-nameservers" name="opt-certificat-finalizer-acme-challenges-dns-01-verification-nameservers">certificat.finalizer.challenges.dns_01.verification_nameservers</a> | | `[]` | A list of servers in the format ip or ip:port. The resolver will use these nameservers when verifying challenges. If left blank the system nameservers will be used. |
